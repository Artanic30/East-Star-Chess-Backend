...
class User(AbstractUser):
    ...
    ups = models.ForeignKey('User', on_delete=models.CASCADE, related_name='ups_user', verbose_name='profile_ups'),
    downs = models.ForeignKey('User', on_delete=models.CASCADE, related_name='downs_user', verbose_name='profile_downs'),
